...
WestcliffEelgrassDir = '../data/Newport_SSINP/Westcliff/Eelgrass/'
...
for(i in (serialnumber)){
  ...
  gapepath=file.path(paste0("../data/Newport_SSINP/alldata/",i))
  ...
  #gapedat=ConcatGapeFiles(gapecombo,myTimeZone="UTC",verbose=F)
  write.csv(gapedat, paste0("../data/Newport_SSINP/combinedgape/", i, "_combogape.csv"), row.names = FALSE)
}
 #write.csv2(get(serialnumber[i]), paste0("../data/Newport_SSINP", serialnumber[i], "combogape.csv"),gapedat)
...
for(i in (serialnumber)){
  #j=paste0(i,"_GAPE.csv")
  gapepath=file.path(paste0("../data/Newport_SSINP/combinedgape/", i, "_combogape.csv"))
    if(!file.exists(gapepath)) {
     next
    }
  #gapdat=read.csv(gapepath)
	...
	write.csv(gapedat, paste0("../data/Newport_SSINP/combinedgape/", i, "_combogape.csv"))
}
