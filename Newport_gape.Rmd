...
metafilePath = paste0(localpath,'Newport_SSINP/field_metadata_withedits_2022-2023.csv')
```
...
metafile = loadFieldMetaData(filename = metafilePath)
...
for(i in (serialnumber)){
  ...
  gapedat=read.csv(gapepath)
	...
	gapedat[,"hallpercent"] = calcPercentGapeNLME(gapedat[,"Hall"], cRegress, 
