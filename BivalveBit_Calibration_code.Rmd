...
```{r trialCurveFitting, echo=FALSE,dpi=300,fig.width=5,fig.cap='Observed readings (open circles) and fitted values (closed circles) derived from nls curve fitting routine.'}
