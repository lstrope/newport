...
DeAnzaMud142Dir='De Anza/Mud/SN142/'

```

```{r getIRdata, echo=FALSE}
# Get a list of the IR heart sensor files by looking for filenames that end in IR.csv
#IRfilenames = dir(path = paste0(NewportDir, DeAnzaMud142Dir), full.names=TRUE, pattern= "*IR.csv")
...
#Load files
HeartDir = '~/Documents/Oyster/data/Newport_SSINP/De Anza/Eelgrass/SN150'
...
#Heart$DateTimePST = Heart$DateTime
